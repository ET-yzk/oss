...
<form action="<c:url value='/CustomerServlet'/>" method="post">
    ...
    <table border="0" align="center" width="45%" style="margin-left: 110px">
        <div>
            <label>用户名</label>
            <input type="text" id="username" name="CName" className="inputText" placeholder="请输入您的用户名" onFocus="YHMonfocu()"
                   onBlur="YHMonblus()"/>
            <span id="YHMerror">
        </span>
        </div>
        <div>
            <label>账号</label>
            <input type="text" id="CAccount" name="CAccount" className="inputText" placeholder="请输入您的账号" onFocus="ZHonfocu()"
                   onBlur="ZHonblus()"/>
            <span id="ZHerror">
        </span>
        </div>
        <div>
            <label>密码</label>
            <input type="password" id="password" name="CPwd" className="inputText" placeholder="请输入您的密码" onFocus="MMonfocu()"
                   onBlur="MMonblus()"/>
            <span id="MMerror">
        </span>
        </div>
        <div>
            <label>确认密码</label>
            <input type="password" id="confirmPassword" name="pwdTmp" className="inputText" placeholder="请确认您的密码" onFocus="QRMMonfocu()"
                   onBlur="QRMMonblus()"/>
            <span id="QRMMerror">
        </span>
        </div>
        ...
        <div>
            <label>联系电话</label>
            <input type="text" id="CPhone" name="CPhone" className="inputText" placeholder="请输入您的联系电话" onFocus="LXDHonfocu()"
                   onBlur="LXDHonblus()"/>
            <span id="LXDHerror">
        </span>
        </div>
        ...
        <div>
            <label>收货地址</label>
            <textarea rows="5" cols="30" name="CAddress" id="CAddress" onFocus="SHDZonfocu()" onBlur="SHDZonblus()"></textarea>
            <span id="SHDZerror">
        </span>
            <td>
...
<%--&lt;%&ndash;            <td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <input type="checkbox" name="sport" checked="checked"/>运动&ndash;%&gt;--%>
<%--&lt;%&ndash;                <input type="checkbox" name="basketball"/>篮球&ndash;%&gt;--%>
<%--&lt;%&ndash;                <input type="checkbox" name="volleyball"/>排球&ndash;%&gt;--%>
<%--&lt;%&ndash;            </td>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td>邮箱</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <input type="text" name="emall" />&ndash;%&gt;--%>
<%--&lt;%&ndash;            </td>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </tr>&ndash;%&gt;--%>
<%--        <tr>--%>
<%--            <td>电话号码</td>--%>
